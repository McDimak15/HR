...
namespace HomewardRagnarok
{
    ...
    public class HomewardModPanel : ModPanelStyle
    {
        ...
        public class AnimatedModName : UIText
        {
            ...
            private static string GetAnimatedText(string text, float time)
            {
                ...
                var startColor = new Color(255, 196, 111);
                var endColor = new Color(232, 148, 60);
        ...
        {
            // Color constants
            private static readonly Color StartGradientColor = new Color(255, 196, 111);
            private static readonly Color EndGradientColor = new Color(232, 148, 60);
            private static readonly Color Circle1Color = new Color(255, 255, 255, 160);
            private static readonly Color Circle2Color = new Color(255, 255, 255, 160);
            private static readonly Color Circle3Color = new Color(255, 255, 255, 160);
            private static readonly Color BagColor = new Color(255, 255, 255);
            ...
            protected override void DrawSelf(SpriteBatch spriteBatch)
            {
                ...
                var bagTexture = ModContent.Request<Texture2D>("HomewardRagnarok/Assets/Panel/BagIcon").Value;
                var magicCircle = ModContent.Request<Texture2D>("HomewardRagnarok/Assets/Panel/MagicCircle").Value;
                var sparkleTexture = ModContent.Request<Texture2D>("HomewardRagnarok/Assets/Panel/Sparkle").Value;
                var ankhTexture = ModContent.Request<Texture2D>("HomewardRagnarok/Assets/Panel/AnkhIcon").Value;
        ...
        public override void Load()
        {
            ...
            {
                panelShader = ModContent.Request<Effect>("HomewardRagnarok/Assets/Panel/PanelGradient", ReLogic.Content.AssetRequestMode.ImmediateLoad).Value;
            }
        }
        ...
        public override bool PreDrawPanel(UIPanel element, SpriteBatch sb, ref bool drawDivider)
        {
            ...
            var borderColor = Color.Lerp(new Color(255, 196, 111), new Color(232, 148, 60), panelHoverIntensity * 0.5f);  
