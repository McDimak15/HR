...
namespace HomewardRagnarok
{
    ...
    public class SilverCrossPlayer : ModPlayer
    {
        public int healerAttackCounter = 0;
        public bool hasSilverCross = false;
    ...
    public class SilverCrossHealer : GlobalItem
    {
        public override bool AppliesToEntity(Item entity, bool lateInstantiation)
        {
            ...
            return ModContent.TryFind<ModItem>("ContinentOfJourney", "SilverCross", out var cross)
        ...
        public override void UpdateAccessory(Item item, Player player, bool hideVisual)
        {
            ...
            var modPlayer = player.GetModPlayer<SilverCrossPlayer>();
            modPlayer.hasSilverCross = true;
        ...
        public override void ModifyHitNPC(Item item, Player player, NPC target, ref NPC.HitModifiers modifiers)
        {
            ...
            if (item.DamageType == healerDamage)
                player.GetModPlayer<SilverCrossPlayer>().OnHealerAttack();
        }
    }

    public class SilverCrossProjCounter : GlobalProjectile
    {
