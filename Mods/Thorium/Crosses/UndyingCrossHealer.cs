...
namespace HomewardRagnarok
{
    ...
    public class UndyingCrossPlayer : ModPlayer
    {
        public int healerAttackCounter = 0;
        public bool hasUndyingCross = false;

        public override void ResetEffects()
        {
            hasUndyingCross = false;
        }
    ...
    public class UndyingCrossHealer : GlobalItem
    {
        ...
        public override void UpdateAccessory(Item item, Player player, bool hideVisual)
        {
            ...
            var modPlayer = player.GetModPlayer<UndyingCrossPlayer>();
            modPlayer.hasUndyingCross = true;
                ...
                thorium.TryFind("HealerDamage", out DamageClass healerDamage))
            {
                ...
                { 
                    ...
                    if (proj.active && proj.type == ModContent.ProjectileType<HealBubble>() && proj.ai[0] == 8) 
                    { 
                        proj.Kill(); 
                    } 
                }

                if (modPlayer.healerAttackCounter >= 5)
                {
        ...
        public override void ModifyHitNPC(Item item, Player player, NPC target, ref NPC.HitModifiers modifiers)
        {
            ...
            if (item.DamageType == healerDamage)
                player.GetModPlayer<UndyingCrossPlayer>().OnHealerAttack();
        }
    }

    public class UndyingCrossProjCounter : GlobalProjectile
    {
